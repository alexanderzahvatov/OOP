class Student:
    ...
    def rate_feedback(self, lecturer, course, grade):
...
best_student_1.rate_feedback(lector_course_1, "Python", 10)
best_student_1.rate_feedback(lector_course_1, "Python", 9)
best_student_1.rate_feedback(lector_course_1, "GIT", 8)
best_student_1.rate_feedback(lector_course_1, "GIT", 7)
best_student_2.rate_feedback(lector_course_2, "Python", 10)
best_student_1.rate_feedback(lector_course_2, "Python", 9)
best_student_1.rate_feedback(lector_course_2, "GIT", 8)
best_student_1.rate_feedback(lector_course_2, "GIT", 7)  #

print(f"\nЗадание № 2. Атрибуты и взаимодействие классов")
print(f"\n{best_student_1.grades}")
print(f"{lector_course_1.student_feedback}")
